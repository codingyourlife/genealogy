...
namespace Shields.GraphViz.Models
{
    public class Graph
    {
        ...
        private readonly IImmutableList<IWriteTo> statements;
        ...
        public IImmutableList<IWriteTo> Statements
        {
        ...
        public Graph Add(SubgraphStatement subgraphStatement)
        {
            return new Graph(graphKind, name, statements.Add(subgraphStatement));
        }
        ...
        public void WriteTo(StreamWriter writer)
        {
            ...
            {
                writer.Write(' ');
                name.WriteTo(writer, putInQuotes: false);
            }
            writer.WriteLine('{');
